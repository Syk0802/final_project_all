...
class Baseline(nn.Module):
    ...
    def forward(self, x, label=None, vis=False):
        ...
        global_feat = self.gap(base_out)  # (b, 2048, 1, 1)
        ...
        if self.training:
            ...
            if self.neck_feat == "after":
                ...
                if not vis:
                    ...
                    localization_map_normed = self.cam(label, base_out)
    ...
    def load_param(self, trained_path, skip_cls=True):
        # param_dict = torch.load(trained_path)  #by wyf
    ...
    def cam(self, label, feature):
        ...
        weight = self.classifier.weight[label][..., None, None]
